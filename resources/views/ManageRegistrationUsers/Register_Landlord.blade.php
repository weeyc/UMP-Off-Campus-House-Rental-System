    ...
    <section class="flex items-stretch h-screen w-screen text-white ">
        <div class="relative items-center hidden w-1/2 bg-gray-500 bg-no-repeat bg-cover lg:flex" style="background-image: url(/images/People/laptop.jpg);">
            ...
            <div class="z-10 w-full px-24 font-black">
                ...
                <p class="my-4 text-3xl font-roboto text-ump-green bg-black bg-opacity-30 italic">Manage your properties and tenants in your fingertips</p>
            </div>
            ...
            <div class="z-auto w-full">
                ...
                <form action="" class="w-full px-6 mx-auto sm:w-2/3 lg:px-0">
                    ...
                    <div class="px-4 pt-4 pb-2">
                        <button class="block w-full p-4 text-lg uppercase rounded-full  bg-blue-600 hover:bg-blue-700 focus:outline-none">sign Up</button>
                    </div>

                </form>
                <p class="px-6 font-nunito text-center ">Already have an account?
                    <a href="/" class="hover:underline hover:text-blue-400">Login Now</a>.
                </p>
            </div>
