...
@section('content')
 ...
 <body class="flex items-center justify-center h-screen overflow-hidden bg-gradient-to-r from-green-300 via-blue-500 to-purple-600" >
    <body>
    <section class="flex items-stretch min-h-screen text-white ">
        <div class="relative items-center hidden w-1/2 bg-gray-500 bg-no-repeat bg-cover lg:flex bg-pekan">
            <div class="absolute inset-0 z-0 bg-black opacity-5"></div>
            <div class="z-10 w-full px-24">
                <h1 class="text-5xl font-bold tracking-wide text-left">Search Accomodation</h1>
                <p class="my-4 text-3xl">Browse your rental house in more secure way, anywhere.</p>
            </div>
        ...
        <div class="z-0 flex items-center justify-center w-full px-0 text-center lg:w-1/2 md:px-16" style="background-color: #161616;">
            ...
            <div class="z-20 w-full py-6">
                ...
                <form action="" class="w-full px-4 mx-auto sm:w-2/3 lg:px-0">
                    <div class="pt-4 pb-2">
                        <input type="email" name="email" id="email" placeholder="Email" class="block w-full p-4 text-lg bg-black rounded-sm">
                    </div>
                    <div class="pt-4 pb-2">
                        <input class="block w-full p-4 text-lg bg-black rounded-sm" type="password" name="password" id="password" placeholder="Password">
                    </div>
                    <div class="text-right text-gray-400 hover:underline hover:text-gray-100">
                        <a href="#">Forgot your password?</a>
                    </div>
                    <div class="px-4 pt-4 pb-2">
                        <button class="block w-full p-4 text-lg uppercase rounded-full bg-ump-green hover:bg-indigo-600 focus:outline-none">sign in</button>
                    </div>
