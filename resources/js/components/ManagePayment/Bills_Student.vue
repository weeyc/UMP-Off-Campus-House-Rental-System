                    ...
                    <tbody>
                      <tr class="hover:bg-grey-lighter text-sm">
                        ...
                        <td rowspan="2" class="py-4 px-6 border-b border-grey-light border-r ">Total Amount<p class="font-black text-xl text-ump-green">RM {{(data.total_bills).toFixed(2)}}</p>
                            <div v-if="data.payment_status==='Unpaid' && data.bills_status==='Ready' && data.bills_status!='Overdue'" class="mb-5 z-10 relative ">
                            ...
                            <div v-else-if="data.bills_status=='Overdue'" class="mb-5 ">
                                <center>
                            ...
                            <div v-else-if="data.payment_status=='Paid'"  class="mb-5 ">
                                <center>
