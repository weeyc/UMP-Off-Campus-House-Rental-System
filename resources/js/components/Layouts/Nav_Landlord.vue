        ...
        <div v-else class="longsheet">
            ...
            <div id="Payment" v-if='n.type==="App\\Notifications\\PaymentNotification"'  class="w-full p-4 mt-4 bg-green-100 rounded flex items-center shadow">
              ...
              <div id="PropertyStatus" v-if='n.type==="App\\Notifications\\PropertyStatusNotification"'  class="w-full p-4 mt-4 bg-red-100 rounded flex items-center shadow">
                <div  class="flex">
                    <div><img @click="notificationHandler(false); redirectFromNoti(5,n.data.Sender_std.staff_id,3)" class="cursor-pointer rounded-full h-10 w-10 object-cover" :src="'/images/Profile/'+n.data.Sender_std.staff_pic" alt="Avatar" /></div>
                    <div class="pl-3">
                    <div tabindex="0" class="focus:outline-none text-sm leading-snug">
                        <div class="leading-snug" ><span @click="notificationHandler(false); redirectFromNoti(5,n.data.Sender_std.staff_id,3)" class="text-indigo-700 cursor-pointer hover:underline font-medium">{{ n.data.Sender_std.staff_name }} </span> (Staff) have updated your </div>
