...
<!-- side bar -->
    <div class="flex flex-1 overflow-hidden">
         ...
         <div :class="[transition]" class=" transform  shadow  inset-y-0 left-0 h-auto  ease-in-out transition-none duration-75 bg-gradient-to-br from-cool-gray-900 to-bg-gradient-to-r-gray-600"  style="background-color: #2b2a33;">
             ...
             <router-link  :to="{name: 'student_landing'}" class="hidden focus:outline-none hover:text-indigo-200 focus:text-indigo-200 text-white sm:flex justify-start p-6 items-center space-x-3 w-full">
            ...
            <div class="mt-4 flex flex-col px-6 justify-start items-center  w-full">
                 <router-link  :to="{name: 'dashboard_student'}" active-class="active" :class="[hover]" class="focus:outline-none flex jusitfy-start  py-3 items-center space-x-6 w-full">
        ...
        <!-- Content -->
                <div class="bg-gradient-to-bl from-yellow-200 via-yellow-300 to-yellow-400  overflow-y-auto" >
                    <router-view :user_id="user_id" :role="role"></router-view>
                        ...
                        <foot-std class="bottom-0 w-full hidden"/>
